    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.modesContainer}>
        <Link href="/study-modal" asChild>
          <TouchableOpacity style={styles.modeBox}><Text style={{fontSize: 30}}>⏳</Text><Text>STUDY</Text></TouchableOpacity>
        </Link>
        <Link href="/deep-modal" asChild>
          <TouchableOpacity style={styles.modeBox}><Text style={{fontSize: 30}}>🔥</Text><Text>DEEP</Text></TouchableOpacity>
        </Link>
      </View>
